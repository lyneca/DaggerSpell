        ...
        public override void Update() {
            ...
            if (daggerActive) {
                foreach (Imbue imbue in summonedDagger.imbues) {
                    try {
                        imbue.Transfer(fireSpellCharge, currentCharge * imbue.maxEnergy - imbue.energy);
                    } catch { }
                }
